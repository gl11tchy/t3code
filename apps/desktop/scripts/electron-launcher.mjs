// This file mostly exists because we want dev mode to say "Glitchy Code (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
// GLITCHY: fork rebrand — must match DesktopEnvironment APP_BASE_NAME / package productName
export const APP_DISPLAY_NAME = isDevelopment ? "Glitchy Code (Dev)" : "Glitchy Code (Alpha)";
